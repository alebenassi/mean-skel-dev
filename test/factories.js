...
var register = function() {
	...
	// Event factory
	factory.define('event', Event, function(buildOptions){
		var attr = {
			title: faker.internet.email() || buildOptions.title,
			description: faker.internet.password() || buildOptions.description,
			date: faker.name.firstName() || buildOptions.date
		};
